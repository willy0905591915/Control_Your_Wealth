document.getElementById("form-button").addEventListener("click", (e) => {
  ...
  if(document.getElementById("form-month").value){
    month = Number(document.getElementById("form-month").value) + 1
  }
  if(document.getElementById("form-year").value){
    year = Number(document.getElementById("form-year").value)
  }
